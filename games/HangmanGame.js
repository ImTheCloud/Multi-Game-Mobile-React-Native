...
export default function HangmanGame() {
  const words = [
    ...
    'VIRTUALIZATION', 'WEB SERVER', 'XML', 'BANDWIDTH', 'HASHING', 'IDE', 'JSON', 'METADATA', 'RAID',
    'SANDBOXING', 'UX', 'BIOS', 'TCP', 'GUI', 'IPV6', 'LAMP', 'NAMESPACE', 'OCR', 'PACKET','MEDOL','PONCHONT',
    ...
    'RETURN', 'INDEX', 'LOGIC', 'THREAD', 'C', 'C++', 'RUBY', 'SWIFT', 'GO', 'RUST', 'TYPESCRIPT','INT','CONST','FINAL','CLASS'
